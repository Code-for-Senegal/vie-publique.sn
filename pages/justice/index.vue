...
const links = [
  {
    ...
    description:
      "Magistrats nommé lors du conseil supérieur de la magistrature",
  ...
  },
  {
    ...
    description:
      "Procès-verbal du Conseil supérieur de la Magistrature de ce vendredi 09 août 2024",
    icon: "i-heroicons-document",
    to: "/publications/justice/conseil-superieur-de-la-magistrature-18-aout-2024",
  },
  {
    label:
      "Textes portant sur les Professions judiciaires et extra judiciaires",
