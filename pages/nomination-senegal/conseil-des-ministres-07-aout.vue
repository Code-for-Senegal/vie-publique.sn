...
const seoImgPath = 'https://vie-publique.sn/images/vpsn-share-nomination-07-aout-2024.png';
const seoPageUrl = 'https://vie-publique.sn/nomination-senegal/conseil-des-ministres-07-aout';
useHead({
    title: 'Nominations Conseil des ministres Sénégal du 07 Aout 2024',
    meta: [
        {
            name: 'description',
            content: 'Nominations Conseil des ministres Sénégal du 07 Aout 2024'
        },
        ...
        },
        {
            ...
            content: "Annuaire des nominations du Conseil des ministres Sénégal du 07 Aout 2024",
        },
...
const { data } = await useFetch('/api/nominations-07-08-2024', {
    watch: false,
    ...
    <div class="flex flex-col items-center px-4">
        ...
        <div class="prose prose-sm sm:prose mx-auto mt-2">
            <h1 class="text-center mt-4 mb-2">
                {{ data.members?.length }} Nominations au conseil des ministres du 07 Aout 2024
            </h1>
        </div>
        ...
        <div class="w-full max-w-4xl">
            ...
            <div class="text-center w-full mb-3">
                <NuxtLink to="/nomination-senegal" class="mb-2 underline text-center">
                    Voir la liste complète des 418 nominations
                </NuxtLink>
            </div>
                    ...
                    <div class="flex flex-row gap-2 ">
                        ...
                        <div class="flex-grow">
                            ...
                            <p class="text-sm text-gray-500">Nommé le
                                ...
                                <span v-if="minister.endDate != null" class="text-sm text-gray-500"> | Fin de fonction:
