...
useHead({
    ...
    meta: [
        {
            name: 'description',
            content: 'Nominations Conseil des ministres Sénégal du 18 Juillet 2024'
        },
        ...
        },
        {
            ...
            content: "Annuaire des nominations du Conseil des ministres Sénégal du 18 Juillet 2024",
        },
...
const { data } = await useFetch('/api/nominations-18-07-2024', {
    watch: false,
