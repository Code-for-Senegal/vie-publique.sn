...
const description = "Suivez les communiqués du Conseil des ministres du gouvernement sénégalais. Décisions, nominations et orientations du gouvernement du Sénégal.";
...
const conseilMinistresSchema = {
  ...
  "about": {
    ...
    "description": "Organe exécutif du gouvernement sénégalais présidé par le Président de la République",
    "parentOrganization": {
      "@type": "GovernmentOrganization",
...
const organizationSchema = {
  ...
  "name": "Conseil des ministres du Sénégal",
  "url": url,
  "description": "Conseil des ministres de la République du Sénégal, organe principal du pouvoir exécutif",
  "address": {
    "@type": "PostalAddress",
...
const { news, loading, error, updateSearch, updatePage } = useConseilMinistres();
...
<template>
  <div class="container mx-auto sm:px-4" itemscope itemtype="https://schema.org/CollectionPage">
          ...
          <UCard>
            ...
            >
              ...
              <div class="p-2">
                ...
                <meta itemprop="about" content="Conseil des ministres du Sénégal">
              </div>
            </NuxtLink>
          </UCard>
        </article>
