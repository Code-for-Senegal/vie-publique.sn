...
const description =
  'Accédez aux annuaires du Sénégal: Nominations Gouvernement, Justice, Media, Sites Web publics et plus encore. Informations officielles et contacts.';
    ...
    itemListElement: [
      {
        ...
        description: 'Premier Ministre et Ministres du gouvernement',
        url: `${siteUrl}/gouvernement-senegal`,
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'Personnalités publiques',
        description: 'Ministres, DG, personnalités publiques',
        url: `${siteUrl}/personnalites-senegal`,
      },
      {
        '@type': 'ListItem',
        position: 3,
...
const menuCategories = [
  {
    title: 'Gouvernement',
    description: 'Premier Ministre et Ministres',
  ...
  {
    title: 'Sites web publics',
    description: 'Sites web publics',
...
<template>
  <div class="min-h-screen bg-gray-50 pb-20 dark:bg-gray-900">
      ...
      <div class="container mx-auto px-4 py-3 md:py-6">
        <div class="flex items-center gap-3">
          ...
          <div class="min-w-0 flex-1">
            <h1 class="text-lg font-bold text-gray-900 dark:text-white md:text-2xl">Annuaires</h1>
    ...
    <main class="container mx-auto px-4 py-4">
      <!-- Intro mobile -->
      <p class="mb-4 text-sm text-gray-600 dark:text-gray-400 md:hidden">
      ...
      <div class="grid grid-cols-1 gap-2 md:grid-cols-2 md:gap-3">
        <NuxtLink
          ...
          :key="menu.title"
          :to="menu.to"
          class="flex items-center gap-4 rounded-xl bg-white p-4 ring-1 ring-gray-100 transition-all active:scale-[0.98] dark:bg-gray-800 dark:ring-gray-700 md:hover:ring-gray-200 dark:md:hover:ring-gray-600"
        >
          <!-- Icon -->
          <div
            :class="[
          ...
          >
            <UIcon :name="menu.icon" :class="[getIconColor(menu.color), 'h-6 w-6 md:h-7 md:w-7']" />
          </div>
      ...
      <div class="mt-6 rounded-2xl bg-gradient-to-br from-sky-500 to-sky-600 p-4 text-white md:p-6">
        ...
        <p class="text-xs leading-relaxed text-white/90 md:text-sm">
          Les annuaires de Vie Publique Sénégal regroupent les informations officielles sur les
          nominations gouvernementales, les représentants élus, les médias reconnus et les sites web
