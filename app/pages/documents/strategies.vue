    ...
    <main class="container mx-auto px-4 py-4">
      ...
      >
        ...
        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
          Impossible de charger les documents de stratégie
        </p>
      </div>
      ...
      >
        ...
        >
          <UIcon name="i-heroicons-presentation-chart-line" class="h-8 w-8 text-gray-400" />
        </div>
