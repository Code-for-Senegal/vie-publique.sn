        ...
        >
          ...
          >
            ...
            <div v-else class="flex h-full w-full items-center justify-center">
              <UIcon name="i-heroicons-scale" class="h-6 w-6 text-gray-300 dark:text-gray-600" />
            </div>
          </div>
          ...
          <div class="flex min-w-0 flex-1 flex-col justify-center">
            ...
            <p
              v-if="(document as any).description"
              class="mt-1 line-clamp-2 text-xs text-gray-500 dark:text-gray-400"
            >
              {{ (document as any).description }}
            </p>
            <div v-if="document.publish_date" class="mt-2 flex items-center gap-1.5 text-xs text-gray-400">
              <UIcon name="i-heroicons-calendar" class="h-3.5 w-3.5" />
              <span>{{ $dateMonthYearformat(document.publish_date) }}</span>
            </div>
          </div>
