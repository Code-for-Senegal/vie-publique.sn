        ...
        <div v-else class="mx-auto max-w-4xl">
          ...
          <div class="mb-4 flex items-center justify-between">
            <p class="text-sm text-gray-500 dark:text-gray-400">
              ...
              <span v-if="selectedCategory !== 'Toutes'" class="text-gray-600 dark:text-gray-300"> · {{ selectedCategory }}</span>
            </p>
          </div>
                  ...
                  >
                    <div class="flex items-center gap-4">
                      <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800">
                        <UIcon name="i-heroicons-bookmark" class="h-5 w-5 text-gray-600 dark:text-gray-400" />
                      </div>
          ...
          <div class="mt-6">
            <NuxtLink
              to="/budget-senegal"
              class="flex w-full items-center justify-center gap-2 rounded-lg bg-gray-900 px-4 py-2.5 text-sm font-medium text-white transition-colors active:bg-gray-800 sm:mx-auto sm:w-auto dark:bg-white dark:text-gray-900 dark:active:bg-gray-100"
            >
