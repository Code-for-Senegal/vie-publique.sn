        ...
        <UCard>
          <div class="space-y-6">
            ...
            <form class="space-y-5" @submit.prevent="handleSubmit">
              ...
              >
                {{ isProcessing ? 'Redirection vers Bictorys...' : 'Procéder au paiement' }}
              </UButton>

              <p class="text-center text-xs text-gray-500 dark:text-gray-400">
                Paiement sécurisé via Bictorys (Carte bancaire, Mobile Money)
              </p>
            </form>
          </div>
        </UCard>
...
// Meta tags SEO
useSeoMeta({
  title: 'Faire un don via Bictorys - Vie Publique Sénégal',
  description:
    'Soutenez Vie Publique Sénégal en faisant un don sécurisé via Bictorys. Contribuez à maintenir une plateforme d\'information publique transparente au Sénégal.',
