...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <header
      class="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-900/95 md:hidden"
    >
    ...
    <div
      class="relative hidden h-48 md:block"
    ...
    >
      ...
      <div class="absolute inset-x-0 top-0 z-40 px-4 py-3">
        <div class="mx-auto flex max-w-6xl items-center gap-4">
          ...
          <div
            v-if="groupById?.status === 'active'"
            class="flex items-center gap-1.5 rounded-full bg-emerald-500/90 px-3 py-1.5 backdrop-blur-sm"
          >
    ...
    <div class="mx-auto max-w-6xl px-4 pb-24">
      ...
      <div class="relative mb-6 md:-mt-16">
        ...
        >
          <div class="flex flex-col items-center gap-5 md:flex-row">
            <!-- Logo -->
            <div
              class="flex h-24 w-24 flex-shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-gray-100 ring-4 ring-white dark:bg-gray-700 dark:ring-gray-800"
            >
              <img
                v-if="groupById.logo"
            ...
            <div class="flex-1 text-center md:text-left">
              ...
              <div class="mt-3 flex flex-wrap justify-center gap-2 md:justify-start">
                <!-- Members count -->
                <span
                  class="inline-flex items-center gap-1.5 rounded-full bg-sky-100 px-3 py-1.5 text-sm font-medium text-sky-700 dark:bg-sky-900/30 dark:text-sky-300"
                >
          ...
          <!-- Description -->
          <p
            v-if="groupById.description"
            class="mt-4 rounded-xl bg-gray-50 p-4 text-sm text-gray-600 dark:bg-gray-700/50 dark:text-gray-300"
          >
      ...
      <!-- Bureau section -->
      <div
        v-if="groupById && (groupById.president || groupById.vice_president)"
        class="mb-6 rounded-2xl bg-white p-5 ring-1 ring-gray-100 dark:bg-gray-800 dark:ring-gray-700"
      >
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <NuxtLink
            ...
            class="group flex items-center gap-4 rounded-xl bg-blue-50 p-4 transition-all hover:bg-blue-100 active:scale-[0.99] dark:bg-blue-900/20 dark:hover:bg-blue-900/30"
          >
            <img
            ...
            <div
              v-else
              class="flex h-14 w-14 items-center justify-center rounded-full bg-blue-100 ring-2 ring-blue-400 dark:bg-blue-800"
            >
            ...
            <div class="min-w-0 flex-1">
              ...
              <span
                class="inline-flex items-center gap-1 rounded-full bg-blue-600 px-2 py-0.5 text-xs font-medium text-white"
              >
          ...
          >
            ...
            <div class="absolute inset-x-0 bottom-0 p-3">
              ...
              <p class="mt-0.5 truncate text-[11px] text-white/80">
                <span v-if="deputy.birthdate"
                  >{{ $getAgeFromBirthdate(deputy.birthdate) }} ans</span
                >
